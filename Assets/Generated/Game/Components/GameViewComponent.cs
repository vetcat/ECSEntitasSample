...
public partial class GameEntity {
    ...
    public Game.Components.ViewComponent view { get { return (Game.Components.ViewComponent)GetComponent(GameComponentsLookup.View); } }
    public bool hasView { get { return HasComponent(GameComponentsLookup.View); } }

    public void AddView(Game.Views.IView newValue) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<Game.Components.ViewComponent>(index);
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceView(Game.Views.IView newValue) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<Game.Components.ViewComponent>(index);
        component.Value = newValue;
